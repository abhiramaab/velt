...
export const SAMPLES: DesignDoc[] = [
  {
    format: "website",
    name: "AURELI",
    tagline: "Architecture of Purpose.",
    theme: {
      bg: "#F9F8F6",
      fg: "#121212",
      muted: "#6B6761",
    ...
    nav: { logo: "AURELI ARCHITEKTEN", links: ["Projects", "Philosophy", "Atelier", "Monograph"], cta: "Inquire" },
    sections: [
      {
        kind: "hero",
        ...
        sub: "Rigorous alpine pavilions, monolithic concrete residences, and spatial restorations designed in dialogue with light.",
        cta: "Explore Monograph",
        secondary: "The Archive",
      },
      {
        kind: "stats",
        items: [
      ...
      },
      {
        ...
        items: [
          { title: "Topography", body: "Every floorplate responds strictly to the bedrock contours of the site." },
          { title: "Monolith", body: "Continuous poured stone and board-formed concrete that weathers with dignity." },
          { title: "Natural Aperture", body: "Framed skylights engineered to track seasonal sun declination without glare." },
        ],
      },
    ],
  },
  {
    ...
    nav: { logo: "LUMEN STUDIO", links: ["Work", "Direction", "Culture Desk", "Journal"], cta: "Book a Call" },
    sections: [
      {
        kind: "hero",
        layout: "editorial-cover",
        ...
        sub: "Art direction, campaign systems, and visual identities for brands that refuse to blend into corporate noise.",
